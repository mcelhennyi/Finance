...
description: >-
  ...
  refreshes project remote-default authority and checks the skeleton hash before
  every wave, syncing only when it changed,
  merges to feat/FR-NNNN-slug, then
