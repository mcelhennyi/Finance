...
- **Integration line:** `feat/FR-0006-budget-cash-flow-graph` at **`7a1381b`** (pushed to **`origin`**). Prior ticket work (**`T-FR-0006-04`** React Flow and related merges) is already on this branch; latest commit adds **Budget UX**: collapsible add areas (allocation line, saved category, cash-flow account), floating-bar **Add** destination modal with scroll-and-expand, and **read-only account rows** with per-row **Edit** / **Done** (inputs only in edit mode).
...
- Feature integration: **`feat/FR-0006-budget-cash-flow-graph`** (includes merge of **`feat/FR-0006-budget-cash-flow-graph--T-FR-0006-04-react-flow`** and subsequent integration commits through **`7a1381b`**).
