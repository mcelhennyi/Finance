...
**Status:** `complete` through post-closeout expansion `T-FR-0006-14`. PR [#9](https://github.com/mcelhennyi/Finance/pull/9) is open from `feat/FR-0006-budget-cash-flow-graph` to `master` and has been refreshed by the responsive Budget width expansion. Latest completed handoff: [`handoffs/2026-07-01-finish-feature-responsive-budget-width.md`](handoffs/2026-07-01-finish-feature-responsive-budget-width.md); closeout: [`90-closeout.md`](90-closeout.md).

**Scope note:** FR-0006 is triad-complete through **`T-FR-0006-14`**. The final post-closeout expansion makes allocation/account tables fit available width and moves dense edit forms out of inline table rows into full-screen/wide modals.
...
| [`30-expand-2026-07-01-responsive-budget-width.md`](30-expand-2026-07-01-responsive-budget-width.md) | Expansion addendum for responsive allocation/account tables and full-screen edit modals |
