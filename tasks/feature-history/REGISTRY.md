...
| FR-0006 | `FR-0006-budget-cash-flow-graph/` | `complete` | **`T-FR-0006-01`** through **`T-FR-0006-13`** in [`FR-0006-budget-cash-flow-graph/tickets.md`](FR-0006-budget-cash-flow-graph/tickets.md) | PR [#9](https://github.com/mcelhennyi/Finance/pull/9) refreshed for post-closeout `T-FR-0006-13`. Persisted **`CashNode`/`CashFlowEdge`**, CRUD API, Budget **React Flow** panel, BBD edge suggestions; expansions add explicit source/sink allocation primitives, role-aware account controls, direct linking, orthogonal routing, expandable allocation clusters, edge/label deconfliction, and graph layout cleanup. |
