...
| FR-0003 | `FR-0003-bbd-projection-ui/` | `complete` | **`T-FR-0003-01`** through **`T-FR-0003-04`** in [`FR-0003-bbd-projection-ui/tickets.md`](FR-0003-bbd-projection-ui/tickets.md) | `finance.bbd.engine`, `POST /api/bbd-projection/run`, **BBD** SPA page; CLI **`scripts/bbd-projection/`** (`README.md`, `HANDOFF.md`, `bbd_projection.py`). |
| FR-0004 | `FR-0004-bbd-projection-experience/` | `design` | **`T-FR-0004-01`** through **`T-FR-0004-05`** in [`FR-0004-bbd-projection-experience/tickets.md`](FR-0004-bbd-projection-experience/tickets.md) | Immersive BBD UI: bottom control dock, **`recharts`** story dashboard, educational callouts, lazy **`three`** / **`@react-three/fiber`** spatial view; builds on **`FR-0003`** API shapes only. |
