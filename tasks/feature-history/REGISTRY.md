...
| FR-0006 | `FR-0006-budget-cash-flow-graph/` | `complete` | **`T-FR-0006-01`** through **`T-FR-0006-14`** in [`FR-0006-budget-cash-flow-graph/tickets.md`](FR-0006-budget-cash-flow-graph/tickets.md) | PR [#9](https://github.com/mcelhennyi/Finance/pull/9) refreshed for post-closeout `T-FR-0006-14`. Persisted **`CashNode`/`CashFlowEdge`**, CRUD API, Budget **React Flow** panel, BBD edge suggestions; expansions add explicit source/sink allocation primitives, role-aware account controls, direct linking, orthogonal routing, expandable allocation clusters, edge/label deconfliction, graph layout cleanup, and responsive Budget table/modal cleanup. |
| FR-0007 | `FR-0007-business-finance-management/` | `design` | **`T-FR-0007-01`** through **`T-FR-0007-13`** in [`FR-0007-business-finance-management/tickets.md`](FR-0007-business-finance-management/tickets.md) | Workspace-scoped business ledger; accounts/cards, balanced review, evidence/deductions, tax obligations/reserves/payments, reports, Business UX, and a deferred governed owner-transfer bridge. |
