...
| FR-0006 | `FR-0006-budget-cash-flow-graph/` | `complete` | **`T-FR-0006-01`** through **`T-FR-0006-12`** in [`FR-0006-budget-cash-flow-graph/tickets.md`](FR-0006-budget-cash-flow-graph/tickets.md) | PR [#9](https://github.com/mcelhennyi/Finance/pull/9) pending human review. Persisted **`CashNode`/`CashFlowEdge`**, CRUD API, Budget **React Flow** panel, time scrub, BBD edge suggestions, Compose default review; expansions add explicit source/sink allocation primitives, account endpoints, direct linking, orthogonal routing, expandable allocation clusters, and edge/label deconfliction. |
