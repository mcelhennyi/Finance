...
| `BbdProjectionPage` | React | Form sections mirroring config groups; displays schedule table + key KPIs + optional MC stats; loading/error states | Frontend |
| Navigation | Layout | New `AppPage` key and nav label (e.g. “BBD projection”) | Frontend |
