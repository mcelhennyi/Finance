...
| T-FR-0006-14 | Responsive Budget tables and full-screen edit forms | done | done | done | `FR-0006` post-closeout expansion; allocation/account tables and mobile cards fit screen width, lower-priority fields collapse, dense edit forms use wide/full-screen modals; Docker frontend lint/test/build (71 tests) and browser desktop/390px VAL passed with 0 console errors |
