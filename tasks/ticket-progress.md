...
| BBD projection (parallel stream) | `T-FR-0003-01` | `FR-0003` | Create `feat/FR-0003-bbd-projection-ui` + worktree under `.worktrees/FR-0003-bbd-projection-ui/` when starting DEV | Independent of **`FR-0002`** |
...
| T-FR-0003-01 | Extract BBD projection as importable module | todo | todo | todo | `FR-0003`; first ticket for BBD UI; deps `none` |
| T-FR-0003-02 | Add BBD projection REST API | todo | todo | todo | `FR-0003`; depends on `T-FR-0003-01` |
| T-FR-0003-03 | Deliver BBD projection page | todo | todo | todo | `FR-0003`; depends on `T-FR-0003-02` |
| T-FR-0003-04 | Validate BBD UX and document operator workflow | todo | todo | todo | `FR-0003`; depends on `T-FR-0003-02` and `T-FR-0003-03` |
