...
description: "Merges feature-prefixed ticket/stage branches into feat/FR-NNNN-slug, validates, runs mandatory feature closeout (90-closeout.md, REGISTRY, ticket-progress) plus explain-feature and a fresh-context update-manual pass, opens PR to the default branch only after docs/ai-context.md §2d feature-complete gate; never auto-deletes remote branches. See skill finish-feature."
---
