...
class AllocationItem(Base):
    ...
    allocation_role: Mapped[str] = mapped_column(String(32), nullable=False, default="sink")
    from_account_ref: Mapped[str | None] = mapped_column(String(64), nullable=True)
    to_account_ref: Mapped[str | None] = mapped_column(String(64), nullable=True)
